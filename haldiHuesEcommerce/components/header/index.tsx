  ...
  return(
    <header className={`site-header ${!onTop ? 'site-header--fixed' : ''}`}>
      ...
      <h1 className="site-logo">
        <span className="site-name">Haldi & Hues</span>
        <span className="powered-by">Powered by QQpay</span>
      </h1>
    </a>
          {/* <a><h1 className="site-logo"><Logo />Haldi & Hues <span>Powered by QQpay</span></h1></a> */}
        </Link>
